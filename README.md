...
> ⚠️ **Importante:** Las variables de entorno fueron incluidas en el repositorio únicamente con fines prácticos para esta prueba técnica. En un entorno de producción, nunca deben versionarse archivos `.env` con información sensible.
